...
const $$Blog = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`<html lang="es"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Krea Proyectos - Blog</title>${renderHead()}</head> ${renderComponent($$result, "DefaultLayout", $$DefaultLayout, {}, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Convocatorias2", $$Convocatorias2, {})} ` })} </html>`;
}, "C:/Users/carlo/Desktop/DEPLOY-PRODUCTION-KREA/krea-front-deploy-production/front/src/pages/blog.astro", void 0);

const $$file = "C:/Users/carlo/Desktop/DEPLOY-PRODUCTION-KREA/krea-front-deploy-production/front/src/pages/blog.astro";
const $$url = "/blog";
